...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_activity_logs_broker_id"), "activity_logs", ["broker_id"], unique=False
    )
    op.create_index(
        op.f("ix_activity_logs_created_at"), "activity_logs", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_activity_logs_deletion_request_id"),
        "activity_logs",
        ["deletion_request_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_activity_logs_email_scan_id"), "activity_logs", ["email_scan_id"], unique=False
    )
    op.create_index(
        op.f("ix_activity_logs_response_id"), "activity_logs", ["response_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "SENT", "CONFIRMED", "REJECTED", name="requeststatus"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_deletion_requests_broker_id"), "deletion_requests", ["broker_id"], unique=False
    )
    op.create_index(
        op.f("ix_deletion_requests_gmail_sent_message_id"),
        "deletion_requests",
        ["gmail_sent_message_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_deletion_requests_gmail_thread_id"),
        "deletion_requests",
        ["gmail_thread_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_email_scans_gmail_message_id"), "email_scans", ["gmail_message_id"], unique=True
    )
    op.create_index(
        op.f("ix_email_scans_sender_domain"), "email_scans", ["sender_domain"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_broker_responses_deletion_request_id"),
        "broker_responses",
        ["deletion_request_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_broker_responses_gmail_message_id"),
        "broker_responses",
        ["gmail_message_id"],
        unique=True,
    )
    op.create_index(
        op.f("ix_broker_responses_gmail_thread_id"),
        "broker_responses",
        ["gmail_thread_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_broker_responses_user_id"), "broker_responses", ["user_id"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_deletion_requests_gmail_sent_message_id"), table_name="deletion_requests"
    )
